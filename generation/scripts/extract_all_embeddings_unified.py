...
Output
------
  embeddings/pmt_embeddings_qmof_all.npz
    Keys:
...
----------------
  python extract_all_embeddings_unified.py \\
      --data_dir /path/to/project/qmof_test_dir \\
...
def main():
    ...
    pa.add_argument("--output_dir", default="./embeddings",
    ...
    # ── Save ─────────────────────────────────────────────────────────
    npz_path = os.path.join(output_dir, "pmt_embeddings_qmof_all.npz")
    np.savez_compressed(
        npz_path,
