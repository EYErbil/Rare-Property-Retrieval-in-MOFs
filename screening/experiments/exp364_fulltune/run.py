#!/usr/bin/env python
"""
Experiment 364: Embedding Split D - Full finetune (no weights)
--------------------------------------------------------------
Strategy D: Farthest-point coverage split.
Full finetune (freeze_layers=0), weights OFF.
Tests if with better split, we can afford to update more parameters.
"""
...
# Default: relative path from repo root — override with --data_dir
